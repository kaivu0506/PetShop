...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 19, 2022 lúc 01:12 PM
...
(75, 16, 'Cát Vệ Sinh Cat\'s Best Original 5L', '<p>Cat&rsquo;s Best Original v&oacute;n cục, thấm h&uacute;t chất lỏng gấp 7 lần thể t&iacute;ch c&aacute;t, kh&oacute;a chặt m&ugrave;i h&ocirc;i v&agrave; vi khuẩn trong một thời gian d&agrave;i nhờ hệ thống mao dẫn của sợi c&acirc;y, giải ph&aacute;p tiết kiệm v&agrave; an to&agrave;n cho cả người, m&egrave;o v&agrave; m&ocirc;i trường.</p>\r\n\r\n<ul>\r\n	<li>Được l&agrave;m từ 100% c&acirc;y hữu cơ thi&ecirc;n nhi&ecirc;n, c&oacute; hương thơm tự nhi&ecirc;n của gỗ</li>\r\n	<li>Cực kỳ tiết kiệm, sau khi x&uacute;c bỏ phần c&aacute;t chứa chất thải, phần c&aacute;t c&ograve;n lại c&oacute; thể d&ugrave;ng tiếp trong 5-7 tuần</li>\r\n	<li>V&oacute;n cục, thấm h&uacute;t lượng chất lỏng lớn gấp 7 lần thể t&iacute;ch của hạt</li>\r\n	<li>Khử m&ugrave;i h&ocirc;i to&agrave;n diện &ndash; kh&ocirc;ng d&ugrave;ng ho&aacute; chất, phụ gia nh&acirc;n tạo</li>\r\n	<li>Nhẹ gấp 3 lần so với c&aacute;t vệ sinh th&ocirc;ng thường, dễ vận chuyển</li>\r\n	<li>Ph&acirc;n huỷ sinh học 100%, th&acirc;n thiện với m&ocirc;i trường, m&egrave;o v&agrave; con người</li>\r\n	<li>Chất thải v&oacute;n lại c&oacute; thể ti&ecirc;u huỷ trong toilet gia đ&igrave;nh hoặc d&ugrave;ng l&agrave;m ph&acirc;n b&oacute;n</li>\r\n	<li>Chất xơ c&oacute; thể ti&ecirc;u ho&aacute; được n&ecirc;n sẽ an to&agrave;n nếu m&egrave;o nuốt phải</li>\r\n</ul>\r\n', '200000.00', 0, 'ori.jpg', '[\"ori1.jpg\"]', 1, 0, 4, 1, 1652953897);
