<div class="row" style="margin-top: 8px;height: 110px">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 clearpadding">
				<a href="<?php echo base_url(); ?>"><img style="max-height: 110px;width: 100%" src="<?php echo base_url(); ?>upload/logo11.png" alt="" class="img-responsive"></a>
			</div>
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
				<a href="<?php echo base_url('khuyen-mai'); ?>"><img style="height: 110px;width: 120%" src="<?php echo base_url(); ?>upload/banner5.jpg" alt="" class="img-responsive"></a>
			</div>
		</div>
		<div class="row"
			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li class="dropdown">
			          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Phân loại<span class="caret"></span></a>
			        ...
			        <li><a href="<?php echo base_url('khuyen-mai'); ?>">Sản phẩm khuyến mại</a></li>
			       </ul>
			      <ul class="nav navbar-nav navbar-right">
			        <?php $this->load->view('site/cart/cart_sh'); ?> <!-- gio hang -->
